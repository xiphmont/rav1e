...
fn sgrproj_box_sum_slow(a: &mut i32, b: &mut i32, row: isize, r: usize,
...
fn sgrproj_box_sum_fastxy_r1(a: &mut i32, b: &mut i32, stripe_x: isize, stripe_y: isize,
                         s: i32, p: &Plane, bit_depth: usize) {
  let mut ssq:i32 = 0;
  let mut sum:i32 = 0;
  for yi in -1..=1 {
...
fn sgrproj_box_sum_fastxy_r2(a: &mut i32, b: &mut i32, stripe_x: isize, stripe_y: isize,
                         s: i32, p: &Plane, bit_depth: usize) {
  let mut ssq:i32 = 0;
  let mut sum:i32 = 0;
  for yi in -2..=2 {
...
fn sgrproj_box_sum_fastx_r1(a: &mut i32, b: &mut i32, row: isize,
                            crop_h: usize, stripe_h: usize,
                            stripe_x: isize, stripe_y: isize,
                            s: i32, cdeffed: &Plane, deblocked: &Plane, bit_depth: usize) {  
  let mut ssq:i32 = 0;
  let mut sum:i32 = 0;
...
fn sgrproj_box_sum_fastx_r2(a: &mut i32, b: &mut i32, row: isize,
                          crop_h: usize, stripe_h: usize,
                          stripe_x: isize, stripe_y: isize,
                          s: i32, cdeffed: &Plane, deblocked: &Plane, bit_depth: usize) {  
  let mut ssq:i32 = 0;
...
fn sgrproj_box_f_r0(f: &mut[i32; 64], x: usize, y: isize, h: usize, cdeffed: &Plane) {
...
fn sgrproj_box_f_r1(af: &[&[i32; 64+2]; 3], bf: &[&[i32; 64+2]; 3], f: &mut[i32; 64],
                 x: usize, y: isize, h: usize, cdeffed: &Plane) {
